...
import ru.manannikov.filesharingservice.services.UserService;
...
import static ru.manannikov.filesharingservice.enums.Role.*;
...
public class SecurityConfig {
    ...
    private static final String[] WHITE_LIST_URL = {
        "/auth/**", "/swagger-ui/**", "/configuration/ui",
     ...
     */
    @Bean
    public AuthenticationManager authenticationProvider(final UserService userService) {
